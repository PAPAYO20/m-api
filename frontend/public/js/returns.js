...
const populateSelectFields = async () => {
  try {
    ...
    const clientSelect = document.getElementById('customerId');
  ...
  try {
    ...
    returns.forEach((returnItem) => {
      response += `<tr>
                      ...
                      <td>
                          <a href='#' onclick="fillReturnForm('${returnItem._id}')">Edit</a> | 
                          <a href='#' onclick="deleteReturn('${returnItem._id}')">Delete</a>
                      </td>
                   </tr>`;
    });
...
const fillReturnForm = async (id) => {
  try {
    ...
    document.getElementById('customerId').value = returnItem.customerId;
